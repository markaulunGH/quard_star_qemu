...
static const MemMapEntry quard_star_memmap[] = {
    ...
    [QUARD_STAR_UART1]       = { 0x10013000,    0x1000 },
    [QUARD_STAR_UART2]       = { 0x10023000,    0x1000 },
    // [QUARD_STAR_UART3]       = { 0x10033000,    0x1000 },

   // [QUARD_STAR_RTC]         = { 0x10003000,    0x1000 },
    [QUARD_STAR_I2C0]        = { 0x10025000,    0x1000 },
    [QUARD_STAR_I2C1]        = { 0x10035000,    0x1000 },
    [QUARD_STAR_I2C2]        = { 0x10006000,    0x1000 },

    [QUARD_STAR_SPI0]        = { 0x10001000,    0x1000 },
    [QUARD_STAR_SPI1]        = { 0x10024000,    0x1000 },
    [QUARD_STAR_GPIO]        = { 0x10012000,    0x1000 },
    [QUARD_STAR_GPIOB]        = { 0x10040000,    0x1000 },
    //[QUARD_STAR_SDIO]        = { 0x1000a000,    0x1000 },
    //[QUARD_STAR_I2S]         = { 0x1000b000,    0x1000 },
    //[QUARD_STAR_CAN]         = { 0x1000c000,    0x1000 },
    [QUARD_STAR_PWM]         = { 0x10005000,    0x1000 },
...
//    [QUARD_STAR_WDT]         = { 0x10014000,    0x1000 },
    ...
    [QUARD_STAR_FLASH]       = { 0x30000000, 0x2000000  },

    [QUARD_STAR_DRAM]        = { 0x80000000, 0x10000000 },
};
                                ...
                                uint64_t kernel_entry, uint32_t fdt_load_addr)
{
    ...
    if (riscv_is_32bit(harts)) {
        reset_vec[4] = 0x0242a583;   /*     lw     a1, 32(t0) */
